...
class GQADataset:
    ...
    def __init__(self, splits: str):
        ...
        # Answers
        self.ans2label = json.load(open("/home/myj/code/lxmert_caption/data/gqa/trainval_ans2label.json"))
        self.label2ans = json.load(open("/home/myj/code/lxmert_caption/data/gqa/trainval_label2ans.json"))
...
class GQABufferLoader():
    ...
    def load_data(self, name, number):
        if name == 'testdev':
            path = "/home/myj/3.7Tfile/data/gqa/frcnn/vg_gqa_imgfeat/gqa_testdev_obj36.tsv"
        else:
            path = "/home/myj/3.7Tfile/data/gqa/frcnn/vg_gqa_imgfeat/vg_gqa_obj36.tsv"
